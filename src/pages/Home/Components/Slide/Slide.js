    ...
    return (
        <div className="slider-area ">
            <div className="slider-active">
                <div className="single-slider slider-height" style={{ backgroundImage: 'url(https://preview.colorlib.com/theme/estore/assets/img/hero/h1_hero.jpg.webp)' }}>
                    <div className="container">
                        <div className="row d-flex align-items-center justify-content-between" style={{ overflow: "hidden" }}>
                            ...
                            <div className="col-xl-5 col-lg-5 col-md-5 col-sm-8">
                                <div className="hero__caption">
                                    ...
                                    <div className="hero__btn" data-animation="fadeInRight" data-delay="1s">
                                        <Link href="#" className="btn hero-btn">Shop Now</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
